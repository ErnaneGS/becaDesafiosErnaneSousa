...
import io.github.becaErnaneSousa.desafios.servicesimplements.CursoServiceImpl;
...
public class CursoController {
    ...
    @PostMapping
    public ResponseEntity<CursoResponse> criar(@RequestBody @Valid CursoRequest cursoRequest) {
    ...
    @PatchMapping("{id}")
    public ResponseEntity <CursoResponse> atualizar(@RequestBody @Valid CursoRequestPatch cursoRequestPatch, @PathVariable Long id) {
